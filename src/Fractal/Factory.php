...
namespace Kelcampus\LaravelRepositoy\Fractal;

use ArrayAccess;
use Kelcampus\LaravelRepositoy\Contracts\Fractal\Factory as FactoryContract;
use Kelcampus\LaravelRepositoy\Fractal\Transformers\GenericTransformer;
